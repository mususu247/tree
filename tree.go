...
func (tw *Twig) getValue(kind ...string) any {
	var result any
	var k string
	//var k string
...
func (root *Tree) getValueStr(src []string) (string, error) {
	...
	result = tw.getValue("string").(string)
...
func (root *Tree) getValueInt(src []string) (int64, error) {
	...
	result = tw.getValue("integer").(int64)
...
func (root *Tree) getValueFloat(src []string) (float64, error) {
	...
	result = tw.getValue("float").(float64)
